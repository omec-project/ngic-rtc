 ...
 */
int8_t
set_base_teid(uint8_t ri_val, uint8_t val, uint32_t upf_ip, teid_info **upf_teid_info_head);
 ...
 */
uint32_t
get_s1u_sgw_gtpu_teid(uint32_t upf_ip, int cp_type, teid_info **upf_teid_info_head);
 ...
 */
uint32_t
get_s5s8_sgw_gtpu_teid(uint32_t upf_ip, int cp_type, teid_info **upf_teid_info_head);
 ...
 */
uint32_t
get_s5s8_pgw_gtpu_teid(uint32_t upf_ip, int cp_type, teid_info **upf_teid_info_head);
 ...
 */
teid_info *
get_teid_info(teid_info **head, uint32_t upf_ip);
 ...
 */
void
delete_entry_from_teid_list(uint32_t upf_ip, teid_info **upf_teid_info_head);
