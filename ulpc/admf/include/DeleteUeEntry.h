...
#ifndef __DELETE_UE_ENTRY_H_
#define __DELETE_UE_ENTRY_H_
...
class DeleteUeEntryPost : public EManagementHandler
{
	public:
		...
		DeleteUeEntryPost(ELogger &audit, AdmfApplication &app); 

		/**
                 * @brief  : Processes the deleteUeEntry rest request on ADMF
