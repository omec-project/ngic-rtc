...
cause_str(enum cause_value cause)
{
	...
	case GTPV2C_CAUSE_BEARER_HANDLING_NOT_SUPPORTED:
		return "GTPV2C_CAUSE_BEARER_HANDLING_NOT_SUPPORTED";
	case GTPV2C_CAUSE_INVALID_PEER:
		return "GTPV2C_CAUSE_INVALID_PEER";
	case GTPV2C_CAUSE_INVALID_REPLY_FROM_REMOTE_PEER:
		return "GTPV2C_CAUSE_INVALID_REPLY_FROM_REMOTE_PEER";
	case GTPV2C_CAUSE_COLLISION_WITH_NW_INIT_REQ:
		return "GTPV2C_CAUSE_COLLISION_WITH_NW_INIT_REQ";
	case GTPV2C_CAUSE_MULTIPLE_PDN_CONNECTIONS_FOR_APN_NOT_ALLOWED:
...
const char *
cause_str_pfcp(enum cause_values_type cause)
{
	...
	case SESSIONCONTEXTNOTFOUND:
		return "PFCP_SESSION_CONTEXT_NOT_FOUND";
	case MANDATORYIEMISSING:
		return "PFCP_MANDATORY_IE_MISSING";
	case CONDITIONALIEMISSING:
		return "PFCP_CONDITIONAL_IE_MISSING";
	case MANDATORYIEINCORRECT:
		return "PFCP_MANDATORY_IE_INCORRECT";
	case INVALIDLENGTH:
		return "PFCP_INVALID_LENGTH";
	case INVALIDFORWARDINGPOLICY:
		return "PFCP_INVALID_FORWARDING_POLICY";
	case INVALIDFTEIDALLOCATIONOPTION:
		return	"PFCP_INVALID_TEID_ALLOCATION";
	case NOESTABLISHEDPFCPASSOCIATION:
		return	"PFCP_NO_ESTABLISHED_PFCP_ASSOCIATION";
	case RULECREATION_MODIFICATIONFAILURE:
		return	"PFCP_RULE_CREATION_MODIFICATION_FAILURE";
	case PFCPENTITYINCONGESTION:
		return	"PFCP_ENTITY_IN_CONGESTION";
	case NORESOURCESAVAILABLE:
		return	"PFCP_NO_RESOURCE_AVAILABLE";
	case SERVICENOTSUPPORTED:
		return	"PFCP_SERVICE_NOT_SUPPORTED";
	case SYSTEMFAILURE:
		return	"PFCP_SYSTEM_FAILURE";
	default:
		return "UNKOWN CAUSE";
	}
}
