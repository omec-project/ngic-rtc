...
*/
int encode_pfcp_sess_rpt_req_t(const pfcp_sess_rpt_req_t *value,
    uint8_t *buf)
{
    uint16_t enc_len = 0;
...
*   number of encoded bytes.
*/
int encode_pfcp_pfd_mgmt_req_t(const pfcp_pfd_mgmt_req_t *value,
    uint8_t *buf)
{
    uint16_t enc_len = 0;
...
*   number of encoded bytes.
*/
int encode_pfcp_create_traffic_endpt_ie_t(const pfcp_create_traffic_endpt_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;

	enc_len = encode_pfcp_ie_header_t(&value->header, buf);
	enc_len /= CHAR_SIZE;
...
*   number of encoded bytes.
*/
int encode_pfcp_pfd_context_ie_t(const pfcp_pfd_context_ie_t *value,
    uint8_t *buf)
{
    uint16_t enc_len = 0;
...
*   number of encoded bytes.
*/
int encode_pfcp_create_urr_ie_t(const pfcp_create_urr_ie_t *value,
    uint8_t *buf)
{
    uint16_t enc_len = 0;
...
*   number of encoded bytes.
*/
int encode_pfcp_eth_pckt_fltr_ie_t(const pfcp_eth_pckt_fltr_ie_t *value,
    uint8_t *buf)
{
    uint16_t enc_len = 0;
...
*   number of encoded bytes.
*/
int encode_pfcp_remove_far_ie_t(const pfcp_remove_far_ie_t *value,
    uint8_t *buf)
{
    uint16_t enc_len = 0;
...
*   number of encoded bytes.
*/
int encode_pfcp_hrtbeat_req_t(const pfcp_hrtbeat_req_t *value,
    uint8_t *buf)
{
    uint16_t enc_len = 0;
...
int encode_pfcp_create_far_ie_t(const pfcp_create_far_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
...
*   number of encoded bytes.
*/
int encode_pfcp_assn_setup_rsp_t(const pfcp_assn_setup_rsp_t *value,
    uint8_t *buf)
{
    uint16_t enc_len = 0;
...
*   number of encoded bytes.
*/
int encode_pfcp_dnlnk_data_rpt_ie_t(const pfcp_dnlnk_data_rpt_ie_t *value,
    uint8_t *buf)
{
    uint16_t enc_len = 0;
    ...
    for (uint8_t i = 0; i < value->pdr_id_count; i++) {
        if (value->pdr_id[i].header.len)
            enc_len += encode_pfcp_pdr_id_ie_t(&(value->pdr_id[i]), buf + enc_len);
    }

    if (value->dnlnk_data_svc_info.header.len)
        enc_len += encode_pfcp_dnlnk_data_svc_info_ie_t(&(value->dnlnk_data_svc_info), buf + enc_len);
...
*   number of encoded bytes.
*/
int encode_pfcp_query_urr_ie_t(const pfcp_query_urr_ie_t *value,
    uint8_t *buf)
{
    uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_assn_setup_req_t(const pfcp_assn_setup_req_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_upd_bar_sess_rpt_rsp_ie_t(const pfcp_upd_bar_sess_rpt_rsp_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_sess_mod_req_t(const pfcp_sess_mod_req_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_usage_rpt_sess_mod_rsp_ie_t(const pfcp_usage_rpt_sess_mod_rsp_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_remove_urr_ie_t(const pfcp_remove_urr_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_sess_rpt_rsp_t(const pfcp_sess_rpt_rsp_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_usage_rpt_sess_del_rsp_ie_t(const pfcp_usage_rpt_sess_del_rsp_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_assn_upd_rsp_t(const pfcp_assn_upd_rsp_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_assn_rel_rsp_t(const pfcp_assn_rel_rsp_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_usage_rpt_sess_rpt_req_ie_t(const pfcp_usage_rpt_sess_rpt_req_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_sess_del_rsp_t(const pfcp_sess_del_rsp_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_sess_set_del_req_t(const pfcp_sess_set_del_req_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
	...
	if (value->up_fqcsid.header.len)
		enc_len += encode_pfcp_fqcsid_ie_t(&(value->up_fqcsid), buf + enc_len);
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_sess_set_del_rsp_t(const pfcp_sess_set_del_rsp_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_created_pdr_ie_t(const pfcp_created_pdr_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_load_ctl_info_ie_t(const pfcp_load_ctl_info_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_sess_mod_rsp_t(const pfcp_sess_mod_rsp_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_created_traffic_endpt_ie_t(const pfcp_created_traffic_endpt_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_pfd_mgmt_rsp_t(const pfcp_pfd_mgmt_rsp_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_upd_traffic_endpt_ie_t(const pfcp_upd_traffic_endpt_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_upd_dupng_parms_ie_t(const pfcp_upd_dupng_parms_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_frwdng_parms_ie_t(const pfcp_frwdng_parms_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
	...
	if (value->dst_intfc_type.header.len)
		enc_len += encode_pfcp_3gpp_intfc_type_ie_t(&(value->dst_intfc_type), buf + enc_len);
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_dupng_parms_ie_t(const pfcp_dupng_parms_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_update_pdr_ie_t(const pfcp_update_pdr_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_upd_frwdng_parms_ie_t(const pfcp_upd_frwdng_parms_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_node_rpt_rsp_t(const pfcp_node_rpt_rsp_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_ovrld_ctl_info_ie_t(const pfcp_ovrld_ctl_info_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_hrtbeat_rsp_t(const pfcp_hrtbeat_rsp_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_node_rpt_req_t(const pfcp_node_rpt_req_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_app_det_info_ie_t(const pfcp_app_det_info_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_pdi_ie_t(const pfcp_pdi_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
	enc_len = encode_pfcp_ie_header_t(&value->header, buf);
...
/* TODO: Revisit this for change in yang */
	if (value->src_intfc.header.len)
		enc_len += encode_pfcp_src_intfc_ie_t(&(value->src_intfc), buf + enc_len);
...
/* TODO: Revisit this for change in yang */
	for (uint8_t i = 0; i < value->eth_pckt_fltr_count; i++) {
		if (value->eth_pckt_fltr[i].header.len)
			enc_len += encode_pfcp_eth_pckt_fltr_ie_t(&(value->eth_pckt_fltr[i]), buf + enc_len);
	}

/* TODO: Revisit this for change in yang */
	for (uint8_t i = 0; i < value->qfi_count; i++) {
		if (value->qfi[i].header.len)
			enc_len += encode_pfcp_qfi_ie_t(&(value->qfi[i]), buf + enc_len);
	}
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_create_bar_ie_t(const pfcp_create_bar_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_sess_del_req_t(const pfcp_sess_del_req_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_assn_upd_req_t(const pfcp_assn_upd_req_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_sess_estab_req_t(const pfcp_sess_estab_req_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
	...
	if (value->apn_dnn.header.len)
		enc_len += encode_pfcp_apn_dnn_ie_t(&(value->apn_dnn), buf + enc_len);
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_err_indctn_rpt_ie_t(const pfcp_err_indctn_rpt_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_eth_traffic_info_ie_t(const pfcp_eth_traffic_info_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_app_ids_pfds_ie_t(const pfcp_app_ids_pfds_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_remove_qer_ie_t(const pfcp_remove_qer_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_create_qer_ie_t(const pfcp_create_qer_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_rmv_traffic_endpt_ie_t(const pfcp_rmv_traffic_endpt_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_update_urr_ie_t(const pfcp_update_urr_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_update_far_ie_t(const pfcp_update_far_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_user_plane_path_fail_rpt_ie_t(const pfcp_user_plane_path_fail_rpt_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_remove_pdr_ie_t(const pfcp_remove_pdr_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_update_qer_ie_t(const pfcp_update_qer_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_add_mntrng_time_ie_t(const pfcp_add_mntrng_time_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_sess_estab_rsp_t(const pfcp_sess_estab_rsp_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_remove_bar_ie_t(const pfcp_remove_bar_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_assn_rel_req_t(const pfcp_assn_rel_req_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_create_pdr_ie_t(const pfcp_create_pdr_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
	...
	for (uint8_t i = 0; i < value->urr_id_count; i++) {
		if (value->urr_id[i].header.len)
			enc_len += encode_pfcp_urr_id_ie_t(&(value->urr_id[i]), buf + enc_len);
	}

	/* TODO: Revisit this for change in yang */
	for (uint8_t i = 0; i < value->qer_id_count; i++) {
		if (value->qer_id[i].header.len)
			enc_len += encode_pfcp_qer_id_ie_t(&(value->qer_id[i]), buf + enc_len);
	}
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_aggregated_urrs_ie_t(const pfcp_aggregated_urrs_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
 ...
 *   number of encoded bytes.
 */
int encode_pfcp_upd_bar_sess_mod_req_ie_t(const pfcp_upd_bar_sess_mod_req_ie_t *value,
		uint8_t *buf)
{
	uint16_t enc_len = 0;
